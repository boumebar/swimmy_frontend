          ...
          <div className="p-8">
            ...
            {isOwner && (
              <div className="flex gap-4 mt-8 pt-8 border-t">
                <button className="flex-1 bg-blue-600 text-white px-6 py-3 rounded font-bold hover:bg-blue-700">
                  Edit Pool
                </button>
                <button className="flex-1 bg-red-600 text-white px-6 py-3 rounded font-bold hover:bg-red-700">
                  Delete Pool
                </button>
              </div>
            )}
